    ...
    <div class="home-page p-8 my-0 mx-auto font-mono text-center">
        ...
        <div class=" md:mx-auto relative bg-white overflow-hidden border-b">
            <div class="h-12 md:ml-10 md:pr-4 md:space-x-8 flex justify-center ">
                ...
                <router-link
                    class="font-medium text-gray-500 hover:text-gray-900 flex items-center"
                    to="/components" exact>Components
                </router-link>
                <router-link
                    class="font-medium text-gray-500 hover:text-gray-900 flex items-center"
                    to="/vueuse" exact>vueUse
                </router-link>
                <router-link
                    class="font-medium text-gray-500 hover:text-gray-900 flex items-center"
                    to="/vueDraggable" exact>vueDraggable
                </router-link>
                <router-link
                    class="font-medium text-gray-500 hover:text-gray-900 flex items-center"
                ...
                <router-link
                    ...
                    to="/proTable" exact>ChatGPT
                </router-link>
                <router-link
                    class="font-medium text-gray-500 hover:text-gray-900 flex items-center"
                    to="/playground" exact>演练场
                </router-link>
                <router-link
                    class="font-medium text-gray-500 hover:text-gray-900 flex items-center"
                    to="/LeafletMap" exact>LeafletMap
                </router-link>
                <router-link
                    class="font-medium text-gray-500 hover:text-gray-900 flex items-center"
                    to="/markDown" exact>MarkDown
                </router-link>
